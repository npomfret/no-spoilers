...
#
# There are seven and there was no way to run them together, so "did I break the
...
status=0
for script in appstore_status testflight_distribute tag_approved appstore_listing appstore_screenshots ci_health teamcity; do
