...
**The Mac App Store `.pkg` is signed with a local *Mac Installer Distribution* identity**, "3rd Party
Mac Developer Installer: Nick Pomfret (6FZN56WC8G)" in the keychain, created on this Mac Studio on
