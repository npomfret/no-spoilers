...
- Use `claude-setup-maintenance` before changing Claude Code instructions, skills, agents, rules, hooks, commands, settings, guides, or verification wrappers.
...
- Ask before introducing new dependencies, abstraction families, file layouts, naming conventions, or implementation patterns.
